...
const PageEditBlog = ({ title, blog }: { title: string; blog: Blog }) => {
    ...
    const [image, setImage] = useState<string>(blog.image as string);
    ...
    useEffect(() => {
        if (recentlySuccessful) {
            toast({
                variant: "default",
                title: `Edit Berita`,
                description: `Berhasil mengubah data berita!`,
            });
        }
    }, [recentlySuccessful])
    ...
    return (
        <MainLayout>
            ...
            <div className='flex flex-col justify-center p-3 max-w-3xl'>
                <h1 className="text-2xl text-black font-bold mb-5">Form Edit Data Berita</h1>
