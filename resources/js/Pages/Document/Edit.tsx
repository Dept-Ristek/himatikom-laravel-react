...
const PageEditDocument = ({ title, document }: { title: string; document: Document }) => {
    ...
    const { data, setData, post, errors, processing, recentlySuccessful } = useForm<Document>({
        ...
        doc_from: document.doc_from ?? null,
        doc_to: document.doc_to ?? null,
    });
    ...
    const [label, setLabel] = useState<{
        ...
        label_tag: selected_tag?.label as string,
        label_type: selected_type?.label as string,
    });
    useEffect(() => {
            ...
            <div className='flex flex-col justify-center p-3 max-w-xl'>
                ...
                <form onSubmit={submit}>
                    ...
                    <div className="mb-2">
                        ...
                        <Input id="filePath" type="file" value={data.filepath as string} onChange={onChangeDocument} className="col-span-3 mb-3 file:bg-slate-200 file:p-2 file:my-auto file:rounded-l-md file:-ml-3 file:-mt-1" />
                    </div>
...
export default PageEditDocument;
