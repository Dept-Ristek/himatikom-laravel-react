...
import MainLayout from "@/Layouts/MainLayout"; // Menggunakan layout dari template
import { useToast } from "@/hooks/use-toast"; // Menggunakan toast dari template
...
export default function CreateEvent({ auth }: PageProps) {
    const { toast } = useToast();
    const { data, setData, post, errors, processing, recentlySuccessful, reset } = useForm({
        name: "",
        description: "",
        start_time: "", // Ubah dari event_time
        end_time: "",   // Tambahkan
        location: "",
        latitude: "",   // Tambahkan
        longitude: "",  // Tambahkan
        ...
        <MainLayout>
            ...
            <div className='p-4 sm:p-6 lg:p-8 max-w-xl mx-auto'>
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h1 className="text-2xl font-bold mb-5">Form Tambah Event</h1>
                    <form onSubmit={submit} className="space-y-4">
                       ...
                       {/* Field Waktu Mulai & Selesai */}
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            ...
                            {/* <Link href={route('admin.events')} className="text-sm text-gray-600 hover:text-gray-900">
                                Batal
                            </Link> */}
                        </div>
                    </form>
