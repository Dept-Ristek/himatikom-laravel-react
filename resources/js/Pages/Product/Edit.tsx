...
const PageEditProduct = ({ title, product }: { title: string; product: Product }) => {
    const availability = [
        {
            id: "ready",
            label: "Ready"
    ...
    const selected = availability.find((val) => val.id === product.availability)
    ...
    const [image, setImage] = useState<string>(product.image as string);
    const [label, setLabel] = useState<{
        label_availability: string | null,
    }>({
        label_availability: selected?.label as string,
    });
    useEffect(() => {
